<footer class="bg-charcoal text-off-white py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-lg font-bold mb-4">Canon Furnitures</h3>
            ...
            <div>
                ...
                <p>Email: info@canonfurnitures.com</p>
                <p>Phone: +254 794 939949</p>
            </div>
        </div>
        <div class="border-t border-gray-600 mt-8 pt-8 text-center">
            <p>&copy; 2023 Canon Furnitures. All rights reserved.</p>
        </div>
    </div>
</footer>
